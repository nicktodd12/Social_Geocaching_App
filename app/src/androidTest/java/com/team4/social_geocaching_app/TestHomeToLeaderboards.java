...
public class TestHomeToLeaderboards extends InstrumentationTestCase {

    @MediumTest
    public void testHomeToLeaderboards() {
        ...
        Instrumentation.ActivityMonitor monitor2 = instrumentation.addMonitor(Leaderboards.class.getName(), null, false);

        // Click the maps button
        final View currentView = currentActivity.findViewById(R.id.leaderboards_button);
        ...
        assertThat(currentActivity, is(notNullValue()));
        assertThat(currentActivity, instanceOf(Leaderboards.class));
